...
class SpruceForestSurvival(BaseSpruceForest, BaseEstimator):
    r"""Spruce Random Forest Survival implementation for sci-kit survival.
    ...
    def estimators_(self):
        ...
        return [
            SpruceTreeSurvival.from_forest(self, idx=idx)
    ...
    def get_estimator(self, idx):
        ...
        if not self.enable_tree_details:
            raise ValueError("enable_tree_details must be True prior to training")
        return SpruceTreeSurvival.from_forest(self, idx=idx)
