"""Cython definition file for C++ classes from spruce, skspruce, and C++ std."""
...
cdef extern from "./spruce/src/globals.h" namespace "spruce":
...
cdef extern from "./spruce/src/utility/Data.cpp":
    pass

cdef extern from "./spruce/src/utility/Data.h" namespace "spruce":
    cdef cppclass Data:
        Data() except +
...
cdef extern from "DataNumpy.h" namespace "spruce":
...
cdef extern from "./spruce/src/Tree/Tree.cpp":
    pass

cdef extern from "./spruce/src/Tree/Tree.h" namespace "spruce":
    cdef cppclass Tree:
        Tree() except +
        Tree(
...
cdef extern from "./spruce/src/Tree/TreeClassification.cpp":
    pass

cdef extern from "./spruce/src/Tree/TreeClassification.h" namespace "spruce":
...
cdef extern from "./spruce/src/Tree/TreeSurvival.cpp":
    pass

cdef extern from "./spruce/src/Tree/TreeSurvival.h" namespace "spruce":
...
cdef extern from "./spruce/src/Tree/TreeRegression.cpp":
    pass

cdef extern from "./spruce/src/Tree/TreeRegression.h" namespace "spruce":
...
cdef extern from "./spruce/src/Tree/TreeProbability.cpp":
    pass

cdef extern from "./spruce/src/Tree/TreeProbability.h" namespace "spruce":
...
cdef extern from "./spruce/src/Forest/Forest.cpp":
    pass

cdef extern from "./spruce/src/Forest/Forest.h" namespace "spruce":
...
cdef extern from "./spruce/src/utility/utility.cpp":
    pass

cdef extern from "./spruce/src/utility/utility.h" namespace "spruce":
    void equalSplit(
...
cdef extern from "./spruce/src/Forest/ForestClassification.cpp":
    pass

cdef extern from "./spruce/src/Forest/ForestClassification.h" namespace "spruce":
...
cdef extern from "./spruce/src/Forest/ForestRegression.cpp":
    pass

cdef extern from "./spruce/src/Forest/ForestRegression.h" namespace "spruce":
...
cdef extern from "./spruce/src/Forest/ForestProbability.cpp":
    pass

cdef extern from "./spruce/src/Forest/ForestProbability.h" namespace "spruce":
...
cdef extern from "./spruce/src/Forest/ForestSurvival.cpp":
    pass

cdef extern from "./spruce/src/Forest/ForestSurvival.h" namespace "spruce":
