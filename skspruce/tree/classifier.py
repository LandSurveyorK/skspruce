...
if t.TYPE_CHECKING:  # pragma: no cover
    from skspruce.ensemble.classifier import SpruceForestClassifier


class SpruceTreeClassifier(BaseSpruceTree, ClassifierMixin):
    r"""Spruce Tree Probability/Classification implementation for sci-kit learn.
    ...
    @classmethod
    def from_forest(cls, forest: "SpruceForestClassifier", idx: int):
        ...
        instance.spruce_class_order_ = forest.spruce_class_order_
    ...
    def fit(
        ...
        """Fit the spruce tree using training data.
