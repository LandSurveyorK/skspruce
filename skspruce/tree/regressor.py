...
if t.TYPE_CHECKING:  # pragma: no cover
    from skspruce.ensemble.regressor import SpruceForestRegressor


class SpruceTreeRegressor(BaseSpruceTree, RegressorMixin, BaseEstimator):
    r"""Spruce Tree Regression implementation for sci-kit learn.
    ...
    @classmethod
    def from_forest(cls, forest: "SpruceForestRegressor", idx: int):
